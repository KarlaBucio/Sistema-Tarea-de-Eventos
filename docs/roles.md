...
| Saúl García Galván | Desarrollo backend | Lógica de eventos y tareas. |
| Edgar Omar García Pardo | Base de datos y pruebas | Modelo de datos y validación. |
| Mónica Nayeli Rodríguez Peña | Desarrollo frontend | Interfaz y experiencia de uso. |
| Karla Paola Baeza López | Documentación y control de calidad | Evidencias, documentación y revisión de entregables. |
